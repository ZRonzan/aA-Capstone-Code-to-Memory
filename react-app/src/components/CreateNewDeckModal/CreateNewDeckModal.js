...
function CreateNewDeckModal({ noClasses, myDeck, setShowDropdown }) {
            ...
            {showModal && (
                <>
                    <Modal
                        ...
                        formType="log-in"
                    >
                        <CreateNewDeckForm setShowModal={setShowModal} myDeck={myDeck} editing={myDeck ? true : false} setShowDropdown={setShowDropdown} />
                    </Modal>
                </>
            )}
        </>
